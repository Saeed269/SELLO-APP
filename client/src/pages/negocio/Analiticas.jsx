...
const s = {
  ...
  cardsGrid: { display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '10px', marginBottom: '1.25rem' },
  statCard: { backgroundColor: '#fff', borderRadius: '14px', padding: '0.85rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px', boxShadow: '0 1px 4px rgba(0,0,0,0.06)', textAlign: 'center' },
